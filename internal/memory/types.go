...
type Memory struct {
	...
	// Phase 4 enhancements: Temporal Resolution & Conflict Detection
	TemporalResolution string   `json:"temporal_resolution"` // Date/time string with degrading precision
	ConflictFlags      []string `json:"conflict_flags"`      // IDs of conflicting memories
